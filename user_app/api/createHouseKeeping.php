...
class CreateHouseKeeping{
    ...
    function insert($user , $booking ,$roomNumber ,$propertyName  , $date , $time  , $paymentMode , $amount){
        ...
        FOD_PAY_{$time}{$date}" ;
        $flag = $this->house->newHouseKeeping($houseKeepingId , $user ,$booking  , $date , $time ,
         $timeSlot , $amount ) ;
        if($flag){
            ...
            $response['msg'] = "House keeping service has been scheduled on {$date} , {$temp}" ;
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $object->insert($userId ,$booking ,$roomNumber ,$propertyName ,$date ,$time ,$paymentMode ,$amount);
